...
%# theorem 1. increasing visibility is efficient but not nash, therefore some measures will lack the support of enough people to become reality. In some game visibility can be endogenous
...
The lag of the target network update

The discount rate (maybe it will prefer to fly)
