...
seed):
    ...
    plt.ylabel('Reward')
    plt.xlabel('Episode')
    plt.savefig('plot_total_reward_per_episode_test.png', format = 'png')
    #
    plt.figure(figsize=(15,8))
    ...
    plt.ylabel('Reward')
    plt.xlabel('Episode')
    plt.savefig('plot_avg_reward_last_100_test.png', format = 'png')
...
Q=sarsa_agent(gamma=0.9,alpha=0.2,epsilon=0.4,n_episodes=100,seed=722060)
